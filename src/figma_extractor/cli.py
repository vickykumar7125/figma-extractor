...
::
    ...
    figma-extractor extract --remote FILE_KEY --output ./out --api-key $FIGMA_API_KEY
...
app = typer.Typer(
    ...
    epilog=(
        "Examples:\n"
        "  figma-extractor extract --file design.fig --output ./out\n"
        "  figma-extractor extract --remote KEY --output ./out --api-key $FIGMA_API_KEY\n"
        "  figma-extractor info --dir ./out"
    ),
)
